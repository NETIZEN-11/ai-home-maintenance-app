...
export default function RegisterScreen({ navigation }) {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      try {
        ...
        // Continue with Firebase only if backend fails
      }
  ...
  const Field = ({ icon, placeholder, value, onChangeText, secure, fieldKey, keyboard }) => (
    ...
    >
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Field icon="person-outline" placeholder="John Doe" value={name} onChangeText={setName} fieldKey="name" />

          <Text style={[styles.label, { marginTop: Spacing.md }]}>Email</Text>
          <Field icon="mail-outline" placeholder="you@example.com" value={email} onChangeText={setEmail} fieldKey="email" keyboard="email-address" />

          <Text style={[styles.label, { marginTop: Spacing.md }]}>Password</Text>
          <Field icon="lock-closed-outline" placeholder="Min. 6 characters" value={password} onChangeText={setPassword} secure fieldKey="password" />

          <Text style={[styles.label, { marginTop: Spacing.md }]}>Confirm Password</Text>
          <Field icon="shield-checkmark-outline" placeholder="Repeat password" value={confirmPassword} onChangeText={setConfirmPassword} secure fieldKey="confirm" />
